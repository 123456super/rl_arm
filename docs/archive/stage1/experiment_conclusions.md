...
> **重构说明（2026-07-28）**：本文件保留原研究主题下的正式 held-out 仿真结论，作为新主题的阶段一基线、问题动机和可复现材料。新论文的研究设计以 [research_direction.md](../../design/research_direction.md) 为准；本文件的三方法排序不得直接写成新论文的最终主结论。

> **文档职责（2026-08-03）：本文件只维护冻结的阶段一结论。项目当前状态和 P3 结果统一见 [docs/current](../../current/research_status.md)。**
