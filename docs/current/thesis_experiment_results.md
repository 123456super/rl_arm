...
> 方法路线已根据门控结果调整：最终 Proposed 使用冻结的 Instant-Link-SAC 名义 actor、候选动作条件预测和轨迹嵌入式多子步安全 QP。第 9--11 节 Predictive-Link-SAC 结果作为负消融；第 7--8 节 endpoint/quintic 结果作为运动连续性过渡消融，均不得改写成最终 Proposed 已验证。
...
```text
outputs/current_results/heldout_1004_1006/final_3methods/all_eval_episodes.csv
outputs/current_results/heldout_1004_1006/final_3methods/eval_summary_by_train_seed.csv
outputs/current_results/heldout_1004_1006/final_3methods/eval_summary_across_train_seeds.csv
outputs/current_results/heldout_1004_1006/final_3methods/eval_summary_macro_across_train_seeds.csv
```
...
```text
outputs/current_results/baseline_3methods_independent_seeds/summary/manifest.json
outputs/current_results/baseline_3methods_independent_seeds/summary/all_eval_episodes.csv
outputs/current_results/baseline_3methods_independent_seeds/summary/eval_summary_by_train_seed.csv
outputs/current_results/baseline_3methods_independent_seeds/summary/eval_summary_across_train_seeds.csv
outputs/current_results/baseline_3methods_independent_seeds/summary/eval_summary_macro_across_train_seeds.csv
```
...
outputs/current_results/minimal_qp_heldout_counterfactual_independent_seeds/summary/all_eval_episodes.csv
outputs/current_results/minimal_qp_heldout_counterfactual_independent_seeds/summary/eval_summary_by_train_seed.csv
...
outputs/current_results/p5_motion_bounds_validation/summary/all_eval_episodes.csv
...
outputs/current_results/p5_motion_bounds_heldout/summary/all_eval_episodes.csv
...
```text
outputs/current_results/p2_predictive_checkpoint_validation/summary/manifest.json
outputs/current_results/p2_predictive_checkpoint_validation/summary/all_eval_episodes.csv
outputs/current_results/p2_predictive_checkpoint_validation/summary/eval_summary_by_train_seed.csv
```
...
```text
outputs/current_results/p2_predictive_100k_checkpoint_validation/summary/manifest.json
outputs/current_results/p2_predictive_100k_checkpoint_validation/summary/all_eval_episodes.csv
outputs/current_results/p2_predictive_100k_checkpoint_validation/summary/eval_summary_by_train_seed.csv
```
...
```text
outputs/current_results/p2_predictive_reward_shaping_validation/summary/manifest.json
outputs/current_results/p2_predictive_reward_shaping_validation/summary/eval_summary_by_train_seed.csv
```
...
- 动作条件预测、Top-k 多子步安全约束或轨迹嵌入式标准凸 QP 已经完成；
- 三个 train seed 已证明统计显著性、广泛泛化或真实机器人安全保证。

原四方法矩阵、`ldrc_adaptive` 反事实、自适应平滑诊断和旧 `outputs/archive_old/formal_legacy/` 结果仅作历史/失败消融，不参与最终排序。第 2--4 节旧三方法结果存在 episode seed 重叠，不得与第 5 节正式基线混用；第 5 节使用历史 EMA 执行器，第 6 节使用 RTB 执行器，两者也不得直接比较 jerk 数值。
