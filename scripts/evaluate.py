                ...
                trace_rows.append(
                    {
                        ...
                        "hierarchical_ik_goal_region_attempted": int(bool(info.get("hierarchical_ik_goal_region_attempted", False))),
                        "hierarchical_ik_goal_region_candidate_count": info.get("hierarchical_ik_goal_region_candidate_count", 0),
                        "hierarchical_ik_goal_region_sample_count": info.get("hierarchical_ik_goal_region_sample_count", 0),
                        "hierarchical_ik_obstacle_aware_attempted": int(bool(info.get("hierarchical_ik_obstacle_aware_attempted", False))),
                        "hierarchical_ik_obstacle_aware_candidate_count": info.get("hierarchical_ik_obstacle_aware_candidate_count", 0),
